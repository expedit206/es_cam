        ...
        >
          ...
          <div class="relative z-10">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-5 md:space-y-6">
              ...
              >
                <label class="flex items-start space-x-3 cursor-pointer">
                  ...
                  />
                  <span class="text-sm md:text-sm text-gray-600">
                    {{ t("accept_terms") }}
                    <router-link
                ...
                <p
                  v-if="errors.terms"
                  class="text-red-500 text-sm mt-2 flex items-center space-x-1"
                >
            ...
            <div class="relative my-6 md:my-8">
              ...
              <div class="relative flex justify-center text-sm md:text-sm">
            ...
            <!-- Lien de connexion -->
            <p
              class="text-center text-sm md:text-sm text-gray-600 mt-4 md:mt-6"
            >
              {{ t("already_member") }}
              <router-link
                to="/login"
