  ...
  <div class="min-h-screen bg-white text-gray-900">
    ...
    <template v-else-if="post">
          ...
          >
            <div class="flex items-center gap-2">
              <div class="w-8 h-8 rounded-full bg-gray-200 overflow-hidden">
                ...
                <div
                  v-else
                  class="w-full h-full flex items-center justify-center bg-gray-700 text-white text-sm font-bold"
                >
      ...
      <main class="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <div class="mt-8">
          <router-link
            to="/blog"
            class="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 hover:text-primary"
          >
        ...
        <section id="comments" class="mt-12">
              ...
              <div class="flex-1">
                ...
                <div class="flex justify-end mt-2">
                  <button
                    ...
                    class="bg-primary text-white px-4 py-1.5 rounded-lg text-sm font-medium disabled:opacity-50"
                  >
          ...
          >
            ...
            <router-link
              to="/login"
              class="bg-primary text-white px-4 py-1.5 rounded-lg text-sm font-medium inline-block"
            >
              Se connecter
            </router-link>
          </div>
                ...
                <div class="flex-1">
                  ...
                  >
                    <textarea
                      ...
                      rows="2"
                      class="w-full bg-white border border-gray-200 rounded-lg p-3 text-sm placeholder:text-gray-400 focus:ring-1 focus:ring-primary outline-none resize-none"
    ...
    <div v-else class="h-screen flex items-center justify-center p-4">
      <div class="text-center">
        ...
        <router-link
          to="/blog"
          class="bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium inline-flex items-center gap-1"
        >
