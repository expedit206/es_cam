    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex items-center justify-between mb-2">
        ...
        <button
          ...
          class="bg-primary text-white px-2 py-1.5 rounded-lg font-medium hover:bg-primary-dark transition-all duration-200 shadow-sm hover:shadow flex items-center gap-1 text-sm"
        >
      ...
      >
        ...
        <div class="flex gap-2 items-center">
            ...
            <input
              ...
              :placeholder="
                catalogStore.activeTab === 'products'
                  ...
                  : t('search_services')
              "
              class="w-full pl-6 pr-5 py-1.5 border border-gray-300 rounded-lg focus:border-primary focus:ring-1 focus:ring-green-200 outline-none transition-all text-sm"
            />
            <button
          ...
          <button
            ...
            class="px-2 py-1.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all flex items-center gap-1 text-sm relative"
          >
          ...
          <button
            ...
            class="px-2 py-1.5 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50 transition-all flex items-center gap-1 text-sm"
          >
        ...
        >
          ...
          >
            <select
              ...
              class="px-1.5 py-1 border border-gray-300 rounded focus:border-primary focus:ring-1 focus:ring-green-200 outline-none transition-all text-sm"
            >
...
onMounted(async () => {
  if (checkAuth("Connectez-vous pour gérer votre catalogue")) {
