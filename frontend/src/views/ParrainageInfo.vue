...
<template>
  <!-- Composants SEO -->
  <SeoHead
    :title="t('referral_info_seo_title')"
    :description="t('referral_info_seo_description')"
    :keywords="t('referral_info_seo_keywords')"
  ...
  >
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div class="space-y-4">
            ...
            <div class="flex items-start space-x-3">
              ...
              <div>
                <h3 class="font-semibold text-gray-900 mb-1">
                  {{ t("step_refer_merchants") }}
                </h3>
                <p class="text-gray-600 text-sm">
                  {{ t("step_refer_merchants_desc") }}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-start space-x-3">
              ...
              <div>
                <h3 class="font-semibold text-gray-900 mb-1">
                  {{ t("step_track_progress") }}
                </h3>
                <p class="text-gray-600 text-sm">
                  {{ t("step_track_progress_desc") }}
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <ul class="space-y-1">
                    <li
                      v-for="avantage in niveau.avantages"
                      :key="avantage"
                      class="flex items-center text-sm text-gray-600"
                    >
                      <i
                        class="fas fa-check text-[var(--espace-vert)] mr-2 text-sm"
                      ></i>
                      {{ avantage }}
                    </li>
                  </ul>
      ...
      <!-- CTA Final -->
      <div
        class="bg-gradient-to-r from-green-700 to-[var(--espace-vert)] rounded-2xl p-8 text-white text-center"
      >
