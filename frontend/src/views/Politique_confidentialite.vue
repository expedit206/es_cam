<template>
  <SeoHead
    ...
    :keywords="t('privacy_policy_keywords')"
    url="https://espacecameroun.com/politique-confidentialite"
    type="article"
  />
  ...
  <div
    class="h-full overflow-y-auto bg-gradient-to-br from-gray-50 to-primary/5"
  >
    <!-- Hero Section -->
    <section
      class="bg-gradient-to-r from-primary to-primary-dark text-white py-16 shadow-lg"
    >
      <div class="max-w-6xl mx-auto text-center px-6">
        <div
          class="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6"
        >
        ...
        <div
          class="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm"
        >
    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
      ...
      <section id="introduction" class="mb-12">
        <div class="bg-white rounded-2xl shadow-sm p-8">
          <h2
            class="text-2xl font-bold text-primary mb-4 flex items-center gap-3"
          >
          ...
          <div class="prose prose-lg text-gray-700">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-6">
              <p class="text-blue-800 text-sm flex items-start gap-3">
                ...
                <span>
                  <strong>{{ t("important_note") }}</strong>
                  {{ t("important_note_text") }}
                </span>
              </p>
            </div>
          </div>
      ...
      <section id="donnees-collectees" class="mb-12">
        <div class="bg-white rounded-2xl shadow-sm p-8">
          <h2
            class="text-2xl font-bold text-primary mb-6 flex items-center gap-3"
          >
            ...
            <div>
              ...
              <div class="space-y-4">
                ...
                <div class="flex items-start gap-3 p-3 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    <strong class="text-gray-900">{{
                      t("service_improvement")
                    }}</strong>
                    <p class="text-gray-600 text-sm">
                      {{ t("service_improvement_desc") }}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8">
          ...
          <div class="mt-6 bg-gray-50 rounded-xl p-4">
            <p class="text-sm text-gray-700">
              <strong>{{ t("how_to_exercise") }}</strong>
              {{ t("contact_dpo") }}
              <a
                href="mailto:espacecameroun@gmail.com"
                class="text-primary hover:underline"
                >espacecameroun@gmail.com</a
              >.
              {{ t("response_time") }}
            </p>
          </div>
...
const navigationSections = [
  ...
  },
  {
    ...
    translationKey: "data_collected",
    icon: "fas fa-database",
  },
  {
    id: "utilisation-donnees",
    translationKey: "data_usage",
    icon: "fas fa-cogs",
  },
  {
    id: "partage-donnees",
    translationKey: "data_sharing",
    icon: "fas fa-share-alt",
  },
  { id: "securite", translationKey: "security", icon: "fas fa-lock" },
  {
    id: "vos-droits",
    translationKey: "your_rights",
