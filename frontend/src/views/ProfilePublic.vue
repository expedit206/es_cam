<template>
  <!-- Composants SEO -->
  <SeoHead
    :title="`${profile?.nom || t('profile')} - ${t('espace_cameroun')}`"
    :description="
      t('user_seo_description', {
  ...
  <div
    class="overflow-y-auto h-full bg-gradient-to-br from-gray-50 to-green-50 py-8 px-4 sm:px-6"
  >
    <div class="max-w-4xl mx-auto">
      <!-- Carte principale du profil -->
      <div class="bg-white rounded-3xl shadow-xl overflow-hidden mb-8">
        <!-- Bannière de profil -->
        <div class="h-32 bg-gradient-to-r from-primary to-primary relative">
          ...
          >
            ...
            <div class="flex-1">
              ...
              <div class="flex flex-wrap items-center gap-3 mb-4">
                ...
                <span
                  v-if="profile?.premium"
                  class="bg-gradient-to-r from-yellow-400 to-yellow-500 text-primary px-3 py-1 rounded-full text-sm font-bold flex items-center gap-2"
                >
                ...
                <!-- Badge Type -->
                <span
                  class="bg-blue-100 text-blue-800 border border-blue-200 px-3 py-1 rounded-full text-sm font-semibold"
                >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div class="flex items-center gap-3 text-gray-600">
                  ...
                  <div>
                    ...
                    <p class="font-medium">
                      {{ profile?.ville || t("city_not_specified") }}
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-center gap-3 text-gray-600">
                  ...
                  <div>
                    ...
                    <p class="font-medium">
                      {{ profile?.telephone || t("not_available") }}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="flex flex-col gap-3">
              <button
                @click="goToChat"
                class="flex items-center justify-center gap-2 bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-dark transition-all shadow-lg hover:shadow-xl min-w-[160px]"
              >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
          ...
          <div class="space-y-3 text-sm text-gray-600">
            ...
            <p
              v-if="profile?.premium && profile?.subscription_ends_at"
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 mb-10">
          ...
          <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-semibold text-primary">{{ t("active") }}</span>
            </div>
            <div class="flex justify-between">
      ...
      <div
        v-if="profile?.produits_count > 0 || profile?.services_count > 0"
        class="mt-8"
      >
        <div class="bg-white rounded-2xl shadow-sm p-6">
