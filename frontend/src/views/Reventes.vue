    ...
    <div class="max-w-6xl mx-auto px-4 py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-gray-700">{{
                  t("no initial investment")
                }}</span>
              </div>
              <div class="flex items-center gap-2">
                <i class="fas fa-check text-green-600 text-sm"></i>
                <span class="text-sm text-gray-700">{{
                  t("expand product catalog")
                }}</span>
              </div>
            </div>
          </div>
      ...
      <div class="sticky top-0 bg-gray-50 z-10 pt-2 pb-4">
        <div class="flex border-b border-gray-200">
          ...
          >
            {{ t("received") }}
            <span class="ml-2 text-sm bg-gray-200 px-2 py-1 rounded-full">
...
onMounted(async () => {
  if (checkAuth("Connectez-vous pour gérer vos reventes")) {
