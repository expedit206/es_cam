    ...
    >
      <div class="flex items-center justify-between">
        ...
        <button
          ...
          class="text-primary hover:text-primary-dark transition-colors flex items-center space-x-2 text-sm"
        >
      ...
      <form v-else @submit.prevent="updateProfile" class="space-y-6">
        ...
        <div class="flex gap-3 pt-4">
          <button
            ...
            :class="[
              'flex-1 bg-primary text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center space-x-2',
              loadingProfile
