<template>
  ...
  >
    <div
      class="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden animate-modal-in"
    >
      <!-- Header -->
      <div
        class="bg-gradient-to-r from-[var(--espace-vert)] to-[var(--espace-vert)] p-6 text-white"
      >
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-white/90 text-sm">
                {{ t("wallet_management_description") }}
              </p>
            </div>
          </div>
          <button
      ...
      <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)] pb-24">
        ...
        <div v-if="isEditing" class="mb-8">
          ...
          >
            <div class="flex items-center gap-3 mb-4">
              ...
              >
                <i
                  :class="currentWallet.id ? 'fas fa-edit' : 'fas fa-plus'"
                ></i>
              </div>
            ...
            <form @submit.prevent="saveWallet" class="space-y-5">
              ...
              <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <label
                    v-for="service in paymentServices"
                    :key="service.value"
                    :class="[
                  ...
                  >
                    <input
                      type="radio"
                      :value="service.value"
                      v-model="currentWallet.payment_service"
                      class="hidden"
                    />
                    ...
                    <div
                      v-if="currentWallet.payment_service === service.value"
              ...
              <div>
                ...
                <input
                  v-model="currentWallet.phone_number"
                  type="tel"
        ...
        <div v-if="wallets && wallets.length > 0" class="space-y-4">
          ...
          <div
            ...
            :key="wallet.id || wallet.phone_number"
          ...
          >
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-4">
                ...
                >
                  <img
                    :src="getServiceLogo(wallet.payment_service)"
                    :alt="wallet.payment_service"
...
const saveWallet = async () => {
  ...
  try {
    if (currentWallet.value.id) {
      await apiClient.put(
        `/wallets/${currentWallet.value.id}`,
        currentWallet.value,
      );
