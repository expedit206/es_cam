  ...
  switch (props.type) {
    ...
    case "webpage":
      return {
        ...
        description:
          props.data?.description || t("structured_data.website_description"),
    ...
    case "product":
      return {
        ...
        description:
          ...
          t("structured_data.default_product_description"),
        ...
        offers: {
          ...
          priceCurrency: "XAF",
          availability:
            props.data?.availability || "https://schema.org/InStock",
          seller: {
            "@type": "Organization",
            name: t("structured_data.organization_name"),
          },
    ...
    case "local_business":
      return {
        ...
        description:
          props.data?.description ||
          t("structured_data.default_merchant_description"),
        url: props.data?.url || baseUrl,
    ...
    case "organization":
      return {
        ...
        contactPoint: {
          ...
          areaServed: "CM",
          availableLanguage: [
            t("structured_data.french"),
            t("structured_data.english"),
          ],
        },
        sameAs: [
    ...
    case "article":
      return {
        ...
        "@type": "Article",
        headline:
          props.data?.title || t("structured_data.default_article_title"),
        description:
          props.data?.description ||
          t("structured_data.default_article_description"),
    ...
    case "person":
      return {
        ...
        description:
          props.data?.description ||
          t("structured_data.default_user_description"),
        url: props.data?.url || baseUrl,
    ...
    case "itemlist":
      return {
        ...
        description:
          props.data?.description ||
          t("structured_data.default_product_catalog"),
        url: props.data?.url || baseUrl,
    ...
    case "howto":
      return {
        ...
        description:
          props.data?.description ||
          t("structured_data.default_guide_description"),
        totalTime: props.data?.duration || "PT10M",
        step:
          props.data?.steps?.map((step: any, index: number) => ({
            "@type": "HowToStep",
            position: index + 1,
            name: step.name,
    ...
    case "faq":
      return {
        ...
        "@type": "FAQPage",
        mainEntity:
          props.data?.questions?.map((faq: any) => ({
            "@type": "Question",
            name: faq.question,
            acceptedAnswer: {
              "@type": "Answer",
