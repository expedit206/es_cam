<template>
  <div>
    ...
    >
      <ServiceSkeleton v-for="i in 10" :key="i" />
    </div>
    ...
    >
      <ServiceCard
        ...
        :key="service?.id"
        :service="service"
        @edit="$emit('edit-service', service)"
        @delete="$emit('delete-service', service?.id)"
    ...
    <div
      ...
      class="text-center py-12 sm:py-16 lg:py-20"
    >
      <div
      ...
      >
        ...
        >
          <i
            class="fas fa-search text-gray-400 text-2xl sm:text-3xl lg:text-4xl"
          ></i>
        </div>
        ...
        >
          <i
            class="fas fa-redo text-sm sm:text-lg group-hover:scale-110 transition-transform"
          ></i>
    ...
    <div v-else class="text-center py-12 sm:py-16 lg:py-20">
      ...
      >
        ...
        >
          <i
            class="fas fa-concierge-bell text-[var(--espace-vert)] text-2xl sm:text-3xl lg:text-4xl"
          ></i>
        </div>
        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">
          {{ t("no_services") }}
        ...
        >
          <i
            class="fas fa-plus-circle text-sm sm:text-lg group-hover:scale-110 transition-transform"
          ></i>
...
import ServiceSkeleton from "../mesServices/ServiceSkeleton.vue";
