<template>
    <div 
        ...
        <div
            ...
            <div class="bg-gradient-to-r from-[var(--espace-vert)] to-[var(--espace-vert)] p-8 text-white relative">
            ...
            <div class="p-8">
                ...
                <div v-if="!selectedPlan">
                    <div class="text-center mb-8">
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ t('choose_your_plan') }}</h3>
                    ...
                    <div class="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        ...
                        <div
                            ...
                            <div class="flex-1">
                                <div class="text-center mb-6">
                                    <h3 class="text-xl font-bold text-gray-800 mb-2">{{ t('free') }}</h3>
                                    <div class="text-3xl font-extrabold text-gray-900 mb-1">0 FCFA</div>
                        ...
                        <div
                            ...
                            <div class="flex-1">
                                <div class="text-center mb-6">
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">{{ t('premium_monthly') }}</h3>
                                    <div class="text-3xl font-extrabold text-[var(--espace-vert)] mb-1">5 000 FCFA</div>
                                ...
                                <ul class="space-y-3 text-sm">
                                    <li class="flex items-start gap-3 text-gray-700">
                                        <i class="fas fa-check text-green-500 mt-1 flex-shrink-0"></i>
                                        <span><strong>{{ t('unlimited_products') }}</strong></span>
                                    </li>
                                    <li class="flex items-start gap-3 text-gray-700">
                                        <i class="fas fa-check text-green-500 mt-1 flex-shrink-0"></i>
                                        <span><strong>{{ t('unlimited_reventes') }}</strong></span>
                                    </li>
                                    <li class="flex items-start gap-3 text-gray-700">
                                        <i class="fas fa-check text-green-500 mt-1 flex-shrink-0"></i>
                                        <span><strong>{{ t('free_tokens_monthly') }}</strong></span>
                                    </li>
                                    <li class="flex items-start gap-3 text-gray-700">
                                        <i class="fas fa-check text-green-500 mt-1 flex-shrink-0"></i>
                                        <span>{{ t('detailed_statistics') }}</span>
                        ...
                        <div
                            ...
                            <div class="flex-1">
                                <div class="text-center mb-6">
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">{{ t('premium_yearly') }}</h3>
                                    <div class="text-3xl font-extrabold text-[var(--espace-or)] mb-1">50 000 FCFA</div>
                                    <p class="text-sm text-gray-600">
                                        <span class="line-through text-gray-400">60 000 FCFA</span>
                                        <span class="text-[var(--espace-vert)] font-bold ml-2">{{ t('save_percentage', {
                                            percentage: 16
                                        }) }}</span>
                                    </p>
                                </div>
                                ...
                                <ul class="space-y-3 text-sm">
                                    ...
                                    <li class="flex items-start gap-3 text-gray-700">
                                        <i class="fas fa-check text-green-500 mt-1 flex-shrink-0"></i>
                                        <span><strong>{{ t('free_tokens_yearly') }}</strong></span>
                                    </li>
                                    <li class="flex items-start gap-3 text-gray-700">
                                        <i class="fas fa-check text-green-500 mt-1 flex-shrink-0"></i>
                    ...
                    <div class="mt-12 bg-gray-50 rounded-2xl p-8 max-w-4xl mx-auto">
                        <h3 class="text-2xl font-bold text-center text-gray-900 mb-6">🎯 {{ t('why_go_premium') }}
                        </h3>
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-2">{{ t('increase_sales') }}</h4>
                                    <p class="text-gray-600 text-sm">{{ t('increase_sales_description') }}</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4">
                                <div
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-2">{{ t('grow_network') }}</h4>
                                    <p class="text-gray-600 text-sm">{{ t('grow_network_description') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-8">
                        ...
                        <div class="lg:w-2/5">
                            <div
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-4">{{ t('your_selection') }}</h3>
                                ...
                                <div :class="[
                                    ...
                                    <div class="flex items-center gap-3 mb-3">
                                        <div :class="[
                                            ...
                                            selectedPlan === 'monthly' ? 'bg-[var(--espace-vert)]' : 'bg-[var(--espace-or)]'
                                        ]">
                                            <i class="fas fa-crown"></i>
                                        </div>
                                        <div>
                                            <h4 class="font-bold text-gray-900">
                                                {{ selectedPlan === 'monthly' ? t('premium_monthly') :
                                                    t('premium_yearly') }}
                                            </h4>
                                            <p class="text-sm text-gray-600">
                                                {{ selectedPlan === 'monthly' ? t('monthly_renewal') :
                                                    t('economical_year') }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">{{ t('subscription') }}:</span>
                                        ...
                                        <div class="flex justify-between text-[var(--espace-vert)]">
                                            ...
                                            <span class="font-semibold">
                                                {{ selectedPlan === 'monthly' ? t('tokens_per_month') :
                                                    t('tokens_per_year') }}
                                            </span>
                                        </div>
                                        <div class="flex justify-between text-[var(--espace-vert)]">
                        ...
                        <div class="lg:w-3/5">
                            <div class="bg-white rounded-2xl p-6 border border-gray-200">
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ t('secure_payment') }}</h3>
                                <p class="text-gray-600 mb-6">{{ t('finalize_subscription') }}</p>
                                ...
                                <form @submit.prevent="confirmUpgrade" class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p v-if="emailError" class="text-red-600 text-sm mt-2 flex items-center gap-2">
                                    ...
                                    <div class="bg-green-50 rounded-xl p-4 border border-green-200">
                                        <div class="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                <h4 class="font-semibold text-green-900">{{ t('secure_redirection') }}
                                                </h4>
                                                <p class="text-sm text-green-700">{{ t('notchpay_redirection_message')
                                                    }}</p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div v-if="isLoading" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[60]">
        <div class="bg-white rounded-2xl p-8 max-w-sm mx-4 text-center">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">{{ t('processing_payment') }}</h3>
...
const confirmUpgrade = async () => {
    ...
    try {
        ...
        if (response.data.redirect_url || response.data.authorization_url) {
            const redirectUrl = response.data.redirect_url || response.data.authorization_url;
