      ...
      <nav class="lg:hidden shadow-gray-900 shadow-xl z-240">
        <div class="flex justify-around items-center py-1">
          <RouterLink
            ...
            class="relative flex flex-col items-center justify-center w-15 hover:text-primary transition-colors duration-300 group featured-item text-primary"
            :class="[
              link.featured ? '' : '',
              $route.path === link.to ? 'text-primary' : '',
            ]"
          ...
          >
            <div class="relative text-center">
              ...
              <span
                ...
                class="cart-badge absolute -top-1 -right-2 bg-secondary text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold"
                :class="{
            ...
            <span
              ...
              :class="
                link.featured ? 'font-bold transform group-hover:scale-105' : ''
              "
            >
              {{ link.label }}
            </span>
            ...
            <div
              v-if="link.featured"
              class="absolute inset-0 bg-gradient-to-r from-transparent via-secondary/10 to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            ></div>
          </RouterLink>
        </div>
      </nav>
