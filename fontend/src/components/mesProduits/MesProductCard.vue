  ...
  >
      ...
      <router-link :to="`/produits/${produit?.id}`" class="block h-full w-full">
        ...
        >
          <div
            ...
            :key="index"
            class="w-full h-full flex-shrink-0 flex items-center justify-center bg-white p-"
          >
            <img
              :src="photo"
      ...
      >
        <div class="relative">
          ...
          >
            ...
            >
              <i
                class="fas fa-edit text-[10px] xs:text-xs text-gray-400 group-hover:text-green-600"
              ></i>
              <span>{{ t("edit") }}</span>
            </button>
            ...
            >
              <i
                class="fas fa-trash text-[10px] xs:text-xs text-gray-400 group-hover:text-red-600"
              ></i>
              <span>{{ t("delete") }}</span>
            </button>
          </div>
    ...
    <div class="p-2 xs:p-3 sm:p-4">
      ...
      <div class="flex items-start justify-between gap-1.5 xs:gap-2">
        <h3
          class="font-semibold text-gray-900 flex-1 line-clamp-1 truncate text-[7px] xs:text-xs min-h-4 sm:text-md leading-tight"
        >
          <router-link
      ...
      <div class="flex justify-between items-center w-full">
        ...
        <div class="flex items-center gap-1">
          ...
          <span
            class="inline-block bg-green-100 text-gray-700 text-[7px] xs:text-[10px] font-medium px-1 py-0.5 xs:px-1 xs:py-1 rounded-full truncate"
          >
