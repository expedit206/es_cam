      ...
      >
        ...
        >
          ...
          >
            <!-- Prix unitaire -->
            <div
              class="bg-gray-50 rounded-lg p-1 flex justify-between items-center text-xs"
            >
          ...
          >
            ...
            <button
              ...
              class="flex items-center gap-2 text-primary border-primary border-2 px-4 py-2 rounded-lg hover:bg-blue-300 transition-all text-xs disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <i
                :class="[
                  'fas',
