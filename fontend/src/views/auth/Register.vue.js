...
__VLS_asFunctionalElement(
  __VLS_intrinsicElements.p,
  __VLS_intrinsicElements.p
)(Object.assign({ class: "text-center text-xs text-gray-400 mt-2 pb-4" }));
__VLS_asFunctionalElement(
